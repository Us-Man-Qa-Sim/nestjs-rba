...
export class RolesUsersRolesPermissionsMigration1722093306743
  implements MigrationInterface
{
  name = 'RolesUsersRolesPermissionsMigration1722093306743';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "roles" DROP CONSTRAINT "FK_23a97f7d96517373f5ea98841c9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8094993d65f5fb97e8d7a213aa"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_920331560282b8bd21bb02290d"`,
    );
